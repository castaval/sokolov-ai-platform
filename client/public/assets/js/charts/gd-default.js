  ...
  var orderOverview = {
    ...
    datasets: [
      ...
      },
      {
        ...
        color: '#9cabff',
        data: [
          2420, 1820, 3000, 5000, 2450, 1820, 2700, 5000, 2400, 2600, 4000,
          2380, 2120, 1700,
        ],
      },
    ],
  ...
  function orderOverviewChart(selector, set_data) {
    ...
    $selector.each(function () {
      var $self = $(this),
        ...
        _get_data = typeof set_data === 'undefined' ? eval(_self_id) : set_data,
        _d_legend =
          typeof _get_data.legend === 'undefined' ? false : _get_data.legend;
    ...
    datasets: [
      {
        ...
        background: NioApp.hexRGB('#798bff', 0.3),
        data: [
          8200, 7800, 9500, 5500, 9200, 9690, 8200, 7800, 9500, 5500, 9200,
          9690, 8200, 7800, 9500, 5500, 9200, 9690, 8200, 7800, 9500, 5500,
          9200, 9690, 8200, 7800, 9500, 5500, 9200, 9690,
        ],
      },
    ],
  };

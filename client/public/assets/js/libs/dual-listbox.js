!(function (t, e) {
  ...
  return (function (t) {
    ...
    './node_modules/sortablejs/modular/sortable.esm.js': function (t, e, n) {
      ...
      function g(t, e, n) {
        t.addEventListener(e, n, !u && m);
      }
      function b(t, e, n) {
        t.removeEventListener(e, n, !u && m);
      }
      function y(t, e) {
        if (e) {
      ...
      function A(t, e, n, o, i) {
        if (t.getBoundingClientRect || t === window) {
          ...
          if (
            (t !== window && t !== L()
              ? ((r = (a = t.getBoundingClientRect()).top),
                (l = a.left),
                (s = a.bottom),
                (c = a.right),
                (d = a.height),
              ...
              : ((r = 0),
                ...
                (h = window.innerWidth)),
            (e || n) && t !== window && ((i = i || t.parentNode), !u))
          )
            do {
              if (
                i &&
                ...
                ('none' !== x(i, 'transform') ||
                  (n && 'static' !== x(i, 'position')))
              ) {
                var f = i.getBoundingClientRect();
                (r -= f.top + parseInt(x(i, 'border-top-width'))),
                  (l -= f.left + parseInt(x(i, 'border-left-width'))),
                  (s = r + a.height),
                  (c = l + a.width);
                break;
              }
      ...
      function k(t, e) {
        for (
          ...
          n &&
          (n === Ht.ghost || 'none' === x(n, 'display') || (e && !y(n, e)));
        ...
        return {
          ...
          animate: function (t, e, n, o) {
            if (o) {
              ...
              (t.animatingX = !!l),
                (t.animatingY = !!s),
                x(t, 'transform', 'translate3d(' + l + 'px,' + s + 'px,0)'),
                (function (t) {
                  t.offsetWidth;
                })(t),
                x(
            ...
            return (
              W.forEach(function (o) {
                'function' == typeof o.eventProperties &&
                  a(n, o.eventProperties.call(e[o.pluginName], t));
              }),
              n
            );
          },
      ...
      var Z,
        ...
        Nt = function (t, e) {
          var n = x(t),
            ...
            s =
              r &&
              parseInt(r.marginLeft) + parseInt(r.marginRight) + A(i).width,
            c =
              l &&
      ...
      var Xt = function (t) {
        ...
        jt = function (t) {
          Z && Z.parentNode[F]._isOutsideThisEl(t.target);
        };
      function Ht(t, e) {
        ...
        var n = {
          ...
          supportPointer: !1 !== Ht.supportPointer && 'PointerEvent' in window,
          emptyInsertThreshold: 5,
        };
        for (var o in (q.initializePlugins(this, t, n), n))
          !(o in e) && (e[o] = n[o]);
        for (var i in (Pt(e), this))
          '_' === i.charAt(0) &&
      ...
      (Ht.prototype = {
            ...
            if (
              ...
              !Z &&
                !(
                  ...
                  o.disabled ||
                  s.isContentEditable ||
                  ((l = E(l, o.draggable, n, !1)) && l.animated) ||
                  et === l
                ))
            ) {
              if (
                ((it = I(l)), (rt = I(l, o.draggable)), 'function' == typeof c)
              ) {
        ...
        _prepareDragStart: function (t, e, n) {
          ...
          if (n && !Z && n.parentNode === a) {
            ...
            if (
                ...
                U('delayEnded', i, { evt: t }),
                  Ht.eventCanceled
                    ...
                    : (i._disableDelayedDragEvents(),
                      !h && i.nativeDraggable && (Z.draggable = !0),
              ...
              g(l, 'mousemove', Xt),
              g(l, 'touchmove', Xt),
              g(l, 'mouseup', i._onDrop),
              g(l, 'touchend', i._onDrop),
              g(l, 'touchcancel', i._onDrop),
              h &&
                this.nativeDraggable &&
              ...
              g(l, 'mouseup', i._disableDelayedDrag),
                g(l, 'touchend', i._disableDelayedDrag),
                g(l, 'touchcancel', i._disableDelayedDrag),
                g(l, 'mousemove', i._delayedDragTouchMoveHandler),
                g(l, 'touchmove', i._delayedDragTouchMoveHandler),
                r.supportPointer &&
                  g(l, 'pointermove', i._delayedDragTouchMoveHandler),
        ...
        _triggerDragStart: function (t, e) {
          (e = e || ('touch' == t.pointerType && t)),
            !this.nativeDraggable || e
              ...
              : (g(Z, 'dragend', this), g(J, 'dragstart', this._onDragStart));
          try {
            document.selection
              ? zt(function () {
        ...
        _dragStarted: function (t, e) {
          if (((Et = !1), J && Z)) {
            U('dragStarted', this, { evt: e }),
              this.nativeDraggable && g(document, 'dragover', jt);
            var n = this.options;
            !t && S(Z, n.dragClass, !1),
              S(Z, n.ghostClass, !0),
              (Ht.active = this),
        ...
        _appendGhost: function () {
          if (!$) {
            ...
            S(($ = Z.cloneNode(!0)), n.ghostClass, !1),
              S($, n.fallbackClass, !0),
              S($, n.dragClass, !0),
              x($, 'transition', ''),
              x($, 'transform', ''),
        ...
        _onDragOver: function (t) {
            ...
            if (
              ...
              u &&
                ...
                (d
                  ? h || (o = !J.contains(Z))
                  : ct === this ||
                    ((this.lastPutMode = st.checkPull(this, u, Z, t)) &&
              ...
              if (
                !m ||
                ((function (t, e, n) {
                  var o = A(k(n.el, n.options.draggable));
                  return e
                ...
                if (
                  (m && a === t.target && (l = m),
                  l && (n = A(l)),
                  !1 !== Yt(J, a, Z, e, l, n, t, !!l))
                )
                  return R(), a.appendChild(Z), (Q = a), H(), j(!0);
                ...
                if (
                  (gt !== l &&
                    ((b = n[D]), (St = !1), (xt = (!w && s.invertSwap) || _)),
                  0 !==
                    (g = (function (t, e, n, o, i, a, r, l) {
                ...
                if (!1 !== P)
                  return (
                    ...
                    N && !M
                      ? a.appendChild(Z)
                      : l.parentNode.insertBefore(Z, N ? M : l),
                    C && X(C, 0, T - C.scrollTop),
                    (Q = Z.parentNode),
                    void 0 === b || xt || (yt = Math.abs(b - A(l)[D])),
                    H(),
                    j(!0)
                  );
              }
          ...
          function j(e) {
            return (
              B('dragOverCompleted', { insertion: e }),
              e &&
                (d ? u._hideClone() : u._showClone(p),
                p !== f &&
                  (S(Z, ct ? ct.options.ghostClass : u.options.ghostClass, !1),
                  S(Z, s.ghostClass, !0)),
                ct !== p && p !== Ht.active
                  ? (ct = p)
                  : p === Ht.active && ct && (ct = null),
              ...
              ((l === Z && !Z.animated) || (l === a && !l.animated)) &&
                (gt = null),
              s.dragoverBubble ||
                t.rootEl ||
                l === document ||
                (Z.parentNode[F]._isOutsideThisEl(t.target), !e && Xt(t)),
        ...
        _offMoveEvents: function () {
          b(document, 'mousemove', this._onTouchMove),
            ...
            b(document, 'dragover', Xt),
            b(document, 'mousemove', Xt),
            b(document, 'touchmove', Xt);
        },
          ...
          (at = I(Z)),
            ...
            Ht.eventCanceled ||
              ...
              t &&
                ...
                Z &&
                  (this.nativeDraggable && b(Z, 'dragend', this),
                  Ft(Z),
                  (Z.style['will-change'] = ''),
                  mt &&
                    !Et &&
                  ...
                  S(Z, this.options.chosenClass, !1),
                  V({
                    sortable: this,
                    name: 'unchoose',
                    toEl: Q,
        ...
        toArray: function () {
          for (
            ...
            E((t = n[o]), a.draggable, this.el, !1) &&
              e.push(t.getAttribute(a.dataIdAttr) || Wt(t));
          return e;
        },
        sort: function (t) {
          var e = {},
        ...
        _showClone: function (t) {
          if ('clone' === t.lastPutMode) {
            if (ot) {
              ...
              J.contains(Z) && !this.options.group.revertClone
                ? J.insertBefore(nt, Z)
                : tt
        ...
        ie = R(function (t, e, n, o) {
          if (e.scroll) {
            ...
            do {
              ...
              var M =
                  E &&
                  (Math.abs(b - a) <= l && T + y < D) -
                    (Math.abs(g - a) <= l && !!T),
                k =
                  w &&
                  (Math.abs(m - r) <= l && O + _ < S) -
                    (Math.abs(v - r) <= l && !!O);
              if (!Jt[d]) for (var I = 0; I <= d; I++) Jt[I] || (Jt[I] = {});
              (Jt[d].vx == M && Jt[d].vy == k && Jt[d].el === f) ||
                ((Jt[d].el = f),
                (Jt[d].vx = M),
                (Jt[d].vy = k),
          ...
          (t.prototype = {
            ...
            dragOverValid: function (t) {
              ...
              if (i.options.swap) {
                ...
                if (n && n !== l) {
                  var c = oe;
                  !1 !== o(n) ? (S(n, s.swapClass, !0), (oe = n)) : (oe = null),
                    c && c !== oe && S(c, s.swapClass, !1);
                }
                a(), e(!0), r();
              }
            },
                ...
                oe &&
                  ...
                  (function (t, e) {
                    var n,
                      ...
                      i = t.parentNode,
                      a = e.parentNode;
                    if (!i || !a || i.isEqualNode(e) || a.isEqualNode(t))
                      return;
                    (n = I(t)), (o = I(e)), i.isEqualNode(a) && n < o && o++;
                    i.insertBefore(e, i.children[n]),
                      a.insertBefore(t, a.children[o]);
                  })(o, oe),
                  i.animateAll(),
                  i !== e && e.animateAll());
            },
        ...
        return (
          (t.prototype = {
            ...
            setupClone: function (t) {
              ...
              if (this.isMultiDrag) {
                for (var o = 0; o < pe.length; o++)
                  ve.push(j(pe[o])),
                    (ve[o].sortableIndex = pe[o].sortableIndex),
                    (ve[o].draggable = !1),
                    (ve[o].style['will-change'] = ''),
                    S(ve[o], this.options.selectedClass, !1),
                    pe[o] === de && S(ve[o], this.options.chosenClass, !1);
                e._hideClone(), n();
              }
            },
            clone: function (t) {
              ...
              this.isMultiDrag &&
                (this.options.removeCloneOnHide ||
                  (pe.length && ue === e && (_e(!0, n), o('clone'), i())));
            },
            ...
            revert: function (t) {
              ...
              pe.length > 1 &&
                (pe.forEach(function (t) {
                  o.addAnimationState({ target: t, rect: ge ? A(t) : i }),
                    Y(t),
                    (t.fromRect = i),
            ...
            dragOverCompleted: function (t) {
              ...
              if (o) {
                if (
                  ...
                  l.animation &&
                    pe.length > 1 &&
                    (ge || (!n && !i.options.sort && !r)))
                ) {
                  var s = A(de, !1, !0, !0);
                  pe.forEach(function (t) {
                    t !== de && (H(t, s), a.appendChild(t));
                  }),
                    (ge = !0);
                }
                if (!n)
                  if ((ge || Ee(), pe.length > 1)) {
                    ...
                    i._showClone(e),
                      i.options.animation &&
                        ...
                        c &&
                        ve.forEach(function (t) {
                          i.addAnimationState({ target: t, rect: he }),
                            (t.fromRect = he),
              ...
              if (e) {
                ...
                if (!be)
                  if (
                    ...
                    S(de, c.selectedClass, !~pe.indexOf(de)),
                    ~pe.indexOf(de))
                  )
                    pe.splice(pe.indexOf(de), 1),
                      (ce = null),
                      G({
                        sortable: i,
                        rootEl: n,
                ...
                if (be && this.isMultiDrag) {
                  if ((o[F].options.sort || o !== n) && pe.length > 1) {
                    ...
                    if (
                      (!me && c.animation && (de.thisAnimationDuration = null),
                      ...
                      !me &&
                        ...
                        Ee(),
                        pe.forEach(function (t) {
                          u[m] ? o.insertBefore(t, u[m]) : o.appendChild(t),
                            m++;
                        }),
                        r === I(de)))
                    ) {
            ...
            nullingGlobal: function () {
              (this.isMultiDrag = be = !1), (ve.length = 0);
            },
            ...
            utils: {
              ...
              deselect: function (t) {
                ...
                e &&
                  e.options.multiDrag &&
                  ~n &&
                  (S(t, e.options.selectedClass, !1), pe.splice(n, 1));
              },
            },
            eventProperties: function () {
              var t = this,
                  ...
                  e.push({ multiDragElement: o, index: o.sortableIndex }),
                    (i =
                      ge && o !== de
                        ? -1
                        : ge
                        ? I(o, ':not(.' + t.options.selectedClass + ')')
                        : I(o)),
        ...
        new (function () {
          ...
          return (
            (t.prototype = {
              ...
              nulling: function () {
                (Qt = Ut = Gt = te = $t = Vt = Zt = null), (Jt.length = 0);
              },
              ...
              _handleAutoScroll: function (t, e) {
                ...
                if (((Qt = t), e || d || u || f)) {
                  ...
                  if (!this.options.bubbleScroll || P(a, !0) === L())
                    return void ee();
        ...
        s = (function () {
          function t(e) {
            ...
            a(this, t),
              ...
              void 0 !== n.options && this._splitOptions(n.options),
            ...
            (n = [
                ...
                value: function (t) {
                  ...
                  i > -1 &&
                    ...
                    setTimeout(function () {
                      ...
                      n.initEvent('added', !1, !0),
                        (n.addedElement = t),
                        e.dualListbox.dispatchEvent(n);
                    }, 0));
                },
              },
              {
              ...
              },
              {
                ...
                value: function (t, e) {
                  for (
                    ...
                    var a = n[i];
                    -1 === a.textContent.toLowerCase().indexOf(o)
              ...
              },
              {
                ...
                value: function (t, e) {
                  for (
                    e.sort(function (t, e) {
                      return parseInt(t.dataset.order) >
                        parseInt(e.dataset.order)
                        ? 1
                        : -1;
                    });
                    t.firstChild;
                ...
                value: function (t) {
                  ...
                  return (
                    t.addEventListener('dblclick', function (n) {
                      return e._actionItemDoubleClick(t, n);
                    }),
                    t.addEventListener('click', function (n) {
                      return e._actionItemClick(t, e.dualListbox, n);
                    }),
                    t
                  );
                },
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return (
                    e.classList.add('dual-listbox__item'),
                    (e.innerHTML = t.text),
                    (e.dataset.id = t.value),
                    console.log(t.dataset.order),
                    t.dataset.order && (e.dataset.order = t.dataset.order),
              ...
              },
              {
                ...
                value: function () {
                  (this.search = document.createElement('input')),
                    this.search.classList.add('dual-listbox__search'),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.dualListbox = document.createElement('div')),
                    this.dualListbox.classList.add('dual-listbox'),
                    this.select.id &&
                    ...
                    this.availableList.classList.add('dual-listbox__available'),
                    o.default.create(this.availableList, {
                      group: 'test',
                      sort: !1,
                      animation: 150,
                    }),
                    this.availableList.addEventListener('end', function (e) {
                      e.to === e.from &&
                        t.reorder(
                          t.available,
                          e.item,
                    ...
                    this.availableList.addEventListener('add', function (e) {
                      t.removeSelected(e.item);
                    }),
                    (this.selectedList = document.createElement('ul')),
                    this.selectedList.classList.add('dual-listbox__selected'),
                    o.default.create(this.selectedList, {
                      group: 'test',
                      animation: 150,
                    }),
                    this.selectedList.addEventListener('end', function (e) {
                      e.to === e.from &&
                        t.reorder(
                          t.selected,
                          e.item,
                    ...
                    this.selectedList.addEventListener('add', function (e) {
                      t.addSelected(e.item, e.newIndex);
                    }),
                    ...
                    this.selectedListTitle.classList.add('dual-listbox__title'),
              ...
              },
              {
                key: 'rebuildOrder',
                value: function () {
                  this.available.forEach(function (t, e) {
                    t.dataset.order = e;
                  }),
                    this.selected.forEach(function (t, e) {
                      t.dataset.order = e;
                    });
                },
              },
                ...
                value: function (t, e, n, o, i) {
                  ...
                  i && t.splice(n, 1),
                    ...
                    setTimeout(function () {
                      ...
                      i.initEvent('reorder', !1, !0),
                        (i.reorderedItem = e),
                        (i.reorderedList = t),
                        (i.reorderedOldValue = n),
                        (i.reorderedNewValue = o),
                        a.dualListbox.dispatchEvent(i);
                    }, 0);
                },
              },
              {
                  ...
                  for (var n = 0; n < e.length; n++) {
                    ...
                    t.isDomElement(o)
                      ? this._addOption({
                          text: o.innerHTML,
                          value: o.value,
                          selected: o.attributes.selected,
                          dataset: {
                            order:
                              o.dataset && o.dataset.order
                                ? o.dataset.order
                                : '',
                          },
                        })

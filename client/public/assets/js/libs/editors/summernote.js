      ...
      (() => {
        ...
        const dt = {
          ...
          splitPoint: function (t, e) {
            ...
            var s =
              o &&
              at(o, t, { isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e });
            return (
            ...
            (n = [
                ...
                value: function (t) {
                  ...
                  (e.shouldInitialize = e.shouldInitialize || m.ok),
                    e.shouldInitialize() &&
                      ...
                      e.events && dt.attachEvents(this.$note, e.events));
                },
              },
              {
                key: 'module',
              ...
              },
              {
                ...
                value: function (t) {
                  var e = this.modules[t];
                  e.shouldInitialize() &&
                    (e.events && dt.detachEvents(this.$note, e.events),
                    e.destroy && e.destroy()),
            ...
            (n = [
              {
                ...
                value: function () {
                  ...
                  var e = vt({ node: this.sc, offset: this.so });
                  return (
                    e.setEndPoint(
                      'EndToEnd',
                      vt({ node: this.ec, offset: this.eo }),
                    ),
                    e
                  );
                },
                ...
                value: function () {
                  var e = function (t, e) {
                      ...
                      if (
                        dt.isVisiblePoint(t) &&
                        (!dt.isEdgePoint(t) ||
                          (dt.isRightEdgePoint(t) && !e) ||
                          (dt.isLeftEdgePoint(t) && e) ||
                          (dt.isRightEdgePoint(t) &&
                            e &&
                            dt.isVoid(t.node.nextSibling)) ||
                          (dt.isLeftEdgePoint(t) &&
                            !e &&
                            dt.isVoid(t.node.previousSibling)) ||
                          (dt.isBlock(t.node) && dt.isEmpty(t.node)))
                      )
                        return t;
                      var o = dt.ancestor(t.node, dt.isBlock),
                        n = !1;
                      if (!n) {
                        var i = dt.prevPoint(t) || { node: null };
                        n =
                          (dt.isLeftEdgePointOf(t, o) || dt.isVoid(i.node)) &&
                          !e;
                      }
                      var r = !1;
                      if (!r) {
                        var a = dt.nextPoint(t) || { node: null };
                        r =
                          (dt.isRightEdgePointOf(t, o) || dt.isVoid(a.node)) &&
                          e;
                      }
                      if (n || r) {
                    ...
                    dt.walkPoint(
                      ...
                      function (e) {
                        ...
                        dt.isEditable(e.node) ||
                          (n
                            ? (dt.isLeftEdgePoint(e) && s.push(e.node),
                              dt.isRightEdgePoint(e) &&
                                y.contains(s, e.node) &&
                                (i = e.node))
                            : (i = o ? dt.ancestor(e.node, t) : e.node),
                          i && t(i) && a.push(i));
                      },
                      !0,
                    ),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    dt.isText(this.ec) &&
                      !dt.isEdgePoint(this.getEndPoint()) &&
                      this.ec.splitText(this.eo),
                    dt.isText(this.sc) &&
                      !dt.isEdgePoint(this.getStartPoint()) &&
                ...
                value: function () {
                  ...
                  return (
                    e().each(n, function (t, e) {
                      var o = e.parentNode;
                      i.node !== o && 1 === dt.nodeLength(o) && r.push(o),
                        dt.remove(e, !1);
                    }),
              ...
              },
              {
                ...
                value: function () {
                  if (dt.isBodyContainer(this.sc) && dt.isEmpty(this.sc))
                    return (
                  ...
                  if (e) {
                    ...
                    if (
                      (i = i.concat(
                        dt.listNext(e.nextSibling, dt.isParaInline),
                      )).length
                    ) {
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    e &&
                      (o = dt.nextPointUntil(o, function (t) {
                        return !dt.isCharPoint(t);
                      })),
              ...
              },
              {
                ...
                value: function (t) {
                  return {
                    s: { path: dt.makeOffsetPath(t, this.sc), offset: this.so },
                    e: { path: dt.makeOffsetPath(t, this.ec), offset: this.eo },
                  };
                },
              },
              {
        ...
        const bt = {
          ...
          createFromNode: function (t) {
            ...
            return (
              dt.isVoid(e) &&
                ((o = dt.listPrev(e).length - 1), (e = e.parentNode)),
              dt.isBR(n)
                ? ((i = dt.listPrev(n).length - 1), (n = n.parentNode))
                : dt.isVoid(n) &&
                  ((i = dt.listPrev(n).length), (n = n.parentNode)),
              this.create(e, o, n, i)
            );
          },
              ...
              },
              {
                ...
                value: function (t) {
                  null !== t.contents && this.$editable.html(t.contents),
                    null !== t.bookmark &&
                      bt.createFromBookmark(this.editable, t.bookmark).select();
                },
              },
              {
                key: 'rewind',
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (t, o) {
                  e().each(
                    t.nodes(dt.isPara, { includeAncestor: !0 }),
                    function (t, n) {
                      e()(n).css(o);
                    },
                  );
              ...
              },
              {
                ...
                value: function (t, o) {
                  ...
                  var a = dt.makePredByNodeName(n),
                    s = t
                      .nodes(dt.isText, { fullyContains: !0 })
                      .map(function (t) {
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return (
                    (n.anchor =
                      t.isOnAnchor() && dt.ancestor(t.sc, dt.isAnchor)),
                    (n.ancestors = dt.listAncestor(t.sc, dt.isEditable)),
                    (n.range = t),
                    n
                  );
                },
              ...
              },
              {
                ...
                value: function (t) {
                  var o = this,
                    ...
                    i = n.nodes(dt.isPara, { includeAncestor: !0 }),
              ...
              },
              {
                ...
                value: function (t, o) {
                  var n = this,
                    ...
                    r = i.nodes(dt.isPara, { includeAncestor: !0 }),
                    a = i.paraBookmark(r),
                  ...
                  if (y.find(r, dt.isPurePara)) {
                    ...
                    var c = i
                      .nodes(dt.isList, { includeAncestor: !0 })
                      .filter(function (o) {
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  return (
                    ...
                    r &&
                      (dt.appendChildNodes(a, y.from(r.childNodes)),
                      dt.remove(r)),
                    t
                  );
                },
                    ...
                    e().each(t, function (t, r) {
                      ...
                      if ('LI' === l.parentNode.nodeName)
                        ...
                        var u =
                          ...
                          d = dt.splitTree(
                            l,
                            { node: a.parentNode, offset: dt.position(a) },
                            { isSkipPaddingBlankHTML: !0 },
                          );
                        (r = o
                          ? dt.listDescendant(d, dt.isLi)
                          : y.from(d.childNodes).filter(dt.isLi)),
                          (!o && dt.isList(l.parentNode)) ||
                            (r = r.map(function (t) {
              ...
              },
              {
                ...
                value: function (t) {
                  return t.previousSibling
                    ? dt.appendChildNodes(t.previousSibling, [t])
                    : this.wrapList([t], 'LI');
                },
              },
              {
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (t, o) {
                  o = (o = (o =
                    o ||
                    bt.create(t)).deleteContents()).wrapBodyInlineWithPara();
                  var n,
                    i = dt.ancestor(o.sc, dt.isPara);
                  if (i) {
                    if (
                      dt.isLi(i) &&
                      (dt.isEmpty(i) || dt.deepestChildIsEmpty(i))
                    )
                      return void this.bullet.toggleList(i.parentNode.nodeName);
                    var r = null;
                    if (
                      (1 === this.options.blockquoteBreakingLevel
                        ? (r = dt.ancestor(i, dt.isBlockquote))
                        : 2 === this.options.blockquoteBreakingLevel &&
                          (r = dt.lastAncestor(i, dt.isBlockquote)),
                      r)
                    ) {
                      (n = e()(dt.emptyPara)[0]),
                        dt.isRightEdgePoint(o.getStartPoint()) &&
                      ...
                      (s = s.concat(dt.listDescendant(n, dt.isEmptyAnchor))),
            ...
            (this.insertParagraph = this.wrapCommand(function () {
              ...
              (this.insertNode = this.wrapCommand(function (t) {
                n.isLimited(e()(t).text().length) ||
                  ...
                  n.setLastRange(bt.createFromNodeAfter(t).select()));
              })),
              ...
              (this.insertHorizontalRule = this.wrapCommand(function () {
                ...
                t.nextSibling &&
                  n.setLastRange(
                    bt.create(t.nextSibling, 0).normalize().select(),
                  );
              })),
            ...
            (n = [
              {
                ...
                value: function () {
                  ...
                  this.$editable
                    ...
                    this.$editable.html(dt.html(this.$note) || dt.emptyPara),
                    this.$editable.on(
                      f.inputEventName,
                      m.debounce(function () {
                  ...
                  return (
                    ...
                    (void 0 === e ||
                      !(
                        ...
                        e.metaKey ||
                        y.contains(
                          [yt.code.BACKSPACE, yt.code.DELETE],
                          e.keyCode,
                        )
                      )) &&
              ...
              },
              {
                ...
                value: function (t) {
                  t
                    ? (this.lastRange = t)
                    : ((this.lastRange = bt.create(this.editable)),
                      0 ===
                        e()(this.lastRange.sc).closest('.note-editable')
                          .length &&
                        (this.lastRange = bt.createFromBodyElement(
                          this.editable,
                        )));
                },
              },
                  ...
                  e()
                    ...
                    .then(function (t) {
                      i.beforeCommand(),
                        ...
                        i.setLastRange(bt.createFromNodeAfter(t[0]).select()),
                        i.afterCommand();
                    })
                    .fail(function (t) {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    t.isOnAnchor() &&
                      (t = bt.createFromNode(dt.ancestor(t.sc, dt.isAnchor))),
                    t.toString()
                  );
                },
              },
                ...
                value: function (t, o) {
                  ...
                  if ('' !== n) {
                    ...
                    if (
                      ...
                      r &&
                        !dt.nodeLength(r) &&
                        ((r.innerHTML = dt.ZERO_WIDTH_NBSP_CHAR),
                        bt.createFromNode(r.firstChild).select(),
                        this.setLastRange(),
            ...
            (o = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    (this.$codable.val(
                      dt.html(this.$editable, this.options.prettifyHtml),
                    ),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var e = this.purify(
                      dt.value(this.$codable, this.options.prettifyHtml) ||
                        dt.emptyPara,
                    ),
            ...
            return (
              ...
              (n = [
                ...
                },
                {
                  key: 'handleKeyup',
                  value: function (t) {
                    y.contains([yt.code.ENTER, yt.code.SPACE], t.keyCode) &&
                      this.replace();
                  },
                },
              ]) && Gt(o.prototype, n),
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  var o =
                    dt.isCell(t) ||
                    dt.isCell(null == t ? void 0 : t.parentElement);
                  if (o) {
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (
                    !y.contains(
                      [yt.code.ENTER, yt.code.UP, yt.code.DOWN],
                      t.keyCode,
                    )
                  ) {
                    var n,
        ...
        var He = Ne('<div class="note-editor note-frame"></div>'),
            ...
            function (t, o) {
              o &&
                ...
                t
                  .data(
                    '_lite_tooltip',
                    new Pe(t, { title: o.tooltip, container: o.container }),
                  )
                  .on('click', function (t) {
            ...
            function (t, o) {
              var n = Array.isArray(o.items)
                ? o.items.map(function (t) {
                    ...
                    return (
                      r.html([so(o.checkClassName), ' ', i]).data('item', t), r
                    );
                  })
                : o.items;
              t.html(n).attr({ 'aria-label': o.title }),
          ...
          Xe = function (t) {
            return Ke([
              ...
              qe([
                Ke({ className: 'note-align', children: t.items[0] }),
                Ke({ className: 'note-list', children: t.items[1] }),
              ]),
            ]).render();
          },
          Qe = function (t) {
          ...
          Je = Ne('<div class="note-color-palette"></div>', function (t, o) {
            ...
            t.html(n.join('')),
              t.find('.note-color-btn').each(function () {
                e()(this).data(
                  '_lite_tooltip',
                  new Pe(e()(this), { container: o.container }),
                );
              });
          }),
          to = function (t, o) {

  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      (e.DATA_KEY = '__blot'),
        ...
        (e.register = function t() {
          ...
          if (((c[r.blotName || r.attrName] = r), 'string' == typeof r.keyName))
            a[r.keyName] = r;
          else if (
            (null != r.className && (s[r.className] = r), null != r.tagName)
          ) {
                ...
                n <= 0 ||
                  (a.default.query(r, a.default.Scope.BLOCK)
                    ...
                    : o(
                        ...
                        'formatAt',
                        this,
                      ).call(this, t, Math.min(n, this.length() - t - 1), r, i),
                  (this.cache = {}));
              },
            },
            {
    ...
    function (t, e, n) {
      ...
      function O(t, e) {
        if (
          ...
          if (((e.theme = _.import('themes/' + e.theme)), null == e.theme))
            throw new Error(
        ...
        return (
          ...
          (e = (0, p.default)(!0, {}, _.DEFAULTS, { modules: r }, n, e)),
    ...
    function (t, e, n) {
      ...
      function i(t) {
        if (r.indexOf(t) <= r.indexOf(o)) {
          for (
            var e, n = arguments.length, i = Array(n > 1 ? n - 1 : 0), l = 1;
            l < n;
            l++
          )
            i[l - 1] = arguments[l];
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  return (
                    ...
                    this.update(
                      new l.default().retain(t).retain(e, (0, d.default)(r)),
                    )
                  );
                },
              },
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  return (
                    ...
                    this.update(
                      new l.default().retain(t).insert(e, (0, d.default)(r)),
                    )
                  );
                },
              },
          ...
          function t(e, n) {
            ...
            f(this, t),
              ...
              this.emitter.listenDOM('selectionchange', document, function () {
                r.mouseDown ||
                  setTimeout(r.update.bind(r, s.default.sources.USER), 1);
              }),
          ...
          attributes: {
            ...
            diff: function (t, e) {
              ...
              var n = Object.keys(t)
                ...
                .reduce(function (n, o) {
                  return (
                    r(t[o], e[o]) || (n[o] = void 0 === e[o] ? null : e[o]), n
                  );
                }, {});
            ...
            },
            {
              ...
              value: function () {
                ...
                !0 !== this.batch &&
                  ...
                  t.length > 0 &&
                    this.emitter.emit(a.default.events.SCROLL_OPTIMIZE, t, n));
              },
            },
            {
              key: 'path',
              ...
              value: function (t) {
                if (!0 !== this.batch) {
                  ...
                  'string' == typeof t && (n = t),
                    ...
                    t.length > 0 &&
                      this.emitter.emit(a.default.events.SCROLL_UPDATE, n, t);
                }
              },
            },
          ]),
                        ...
                        if (null != s && t.quill.hasFocus()) {
                          var u = t.quill.getLine(s.index),
                            ...
                            g =
                              0 === s.length
                                ? [v, b]
                                : t.quill.getLeaf(s.index + s.length),
                            m = o(g, 2),
                            _ = m[0],
                            O = m[1],
                            w =
        ...
        if (!(0 === t.index || this.quill.getLength() <= 1)) {
          ...
          this.quill.deleteText(t.index - f, f, h.default.sources.USER),
            Object.keys(i).length > 0 &&
              this.quill.formatLine(t.index - f, f, i, h.default.sources.USER),
            this.quill.focus();
        }
      }
      function w(t, e) {
      ...
      function x(t) {
        ...
        this.quill.deleteText(t, h.default.sources.USER),
          Object.keys(n).length > 0 &&
            this.quill.formatLine(t.index, 1, n, h.default.sources.USER),
          ...
          Object.keys(e.format).forEach(function (t) {
            null == r[t] &&
              (Array.isArray(e.format[t]) ||
                ('link' !== t &&
                  n.quill.format(t, e.format[t], h.default.sources.USER)));
          });
      }
      function E(t) {
        return {
          ...
          i(e, [
            ...
            },
            {
              ...
              value: function (t, n) {
                ...
                for (
                  var r = this, i = 0;
                  null != r && r.statics.scope !== l.default.Scope.BLOCK_BLOT;
                ...
                if (!this.selection.composing && null != this.parent) {
                  ...
                  if ((this.remove(), null != i)) {
                    ...
                    return (
                      (i = h[0]),
                      (s = h[1]),
                      { startNode: o, startOffset: i, endNode: o, endOffset: s }
                    );
                  }
                }
              },
    ...
    function (t, e, n) {
      ...
      var u = (function (t) {
        ...
        f = new u('color', 'color', { scope: l.default.Scope.INLINE });
    ...
    function (t, e, n) {
      ...
      var r,
        o = n(0),
        i = (r = o) && r.__esModule ? r : { default: r };
      var l = { scope: i.default.Scope.BLOCK, whitelist: ['rtl'] },
                    ...
                    if (
                      ...
                      return (
                        null == t.querySelector('option') &&
                          k(t, g, 'background' === n ? '#ffffff' : '#000000'),
                        new u.default(t, e[n])
                      );
                    }
                    return (
                      null == t.querySelector('option') &&
                        (t.classList.contains('ql-font')
                          ...
                          ? k(t, _)
                          : t.classList.contains('ql-size') && k(t, O)),
                      new f.default(t)
                    );
                  });
                ...
                var a = function (t, e) {
                  ...
                  s = function (t) {
                    null != t.domNode[l.DATA_KEY] &&
                      null != t.domNode[l.DATA_KEY].mutations &&
                      (t instanceof i.default && t.children.forEach(s),
                      t.optimize(n));
                  },
                  u = e,
                  c = 0;
              ...
              0 == e[r - 1][0] &&
                ...
                e[r - 1][1]
                  ...
                  : e[r][1].substring(0, e[r + 1][1].length) == e[r + 1][1] &&
                    ((e[r - 1][1] += e[r + 1][1]),
                    (e[r][1] =
                      e[r][1].substring(e[r + 1][1].length) + e[r + 1][1]),
                    e.splice(r + 1, 1),
                    (c = !0))),
                r++;
            c && t(e);
          ...
          null != l &&
            (f = (function (t, e) {
              ...
              if (null != l && 0 === l[1].indexOf(i[1])) {
                ...
                return (
                  s.length > 0 && r.splice(o + 2, 0, [l[0], s]), a(r, o, 3)
                );
              }
              return t;
            })(f, l)),
    ...
    function (t, e) {
      ...
      Object.create &&
        ((o.prototype = Object.create(null)), new o().__proto__ || (r = !1)),
    ...
    function (t, e, n) {
                ...
                value: function (t) {
                  ...
                  return (
                    q(u, '\n') &&
                      ...
                      (u = u.compose(
                        new a.default().retain(u.length() - 1).delete(1),
                      )),
      ...
      function L(t, e) {
        return (
          q(e, '\n') ||
            ((T(t) || (e.length() > 0 && t.nextSibling && T(t.nextSibling))) &&
              e.insert('\n')),
          e
        );
      }
          ...
          function e(t, n) {
            ...
            return i.container instanceof HTMLElement
              ? (i.container.classList.add('ql-toolbar'),
                ...
                i)
              : ((o = h.error('Container required for toolbar', i.options)),
                f(i, o));
          }
          return (
            (function (t, e) {
                  ...
                  if (n) {
                    ...
                    t.addEventListener(o, function (o) {
                      ...
                      if (null != e.handlers[n]) e.handlers[n].call(e, s);
                        ...
                        l.default.query(n).prototype instanceof l.default.Embed
                      ) {
                ...
                value: function () {
                  ...
                  if (!this.quill.selection.composing) {
                    ...
                    this.quill.scroll.descendants(f).forEach(function (e) {
                      ...
                      null != e &&
                        this.quill.setSelection(e, i.default.sources.SILENT);
                  }
                },
              },
            ]),

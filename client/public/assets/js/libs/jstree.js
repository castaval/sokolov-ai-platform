    ...
    !c &&
      ...
      (e.jstree.core.prototype = {
        plugin: function (t, i) {
          ...
          return r
            ? ((this._data[t] = {}), (r.prototype = this), new r(i, this))
            : this;
        },
        init: function (t, i) {
          (this._model = {
        ...
        _kbevent_to_func: function (e) {
          ...
          if (
            ...
            'shift-shift' === (t = t.sort().join('-').toLowerCase()) ||
              'ctrl-ctrl' === t ||
              'alt-alt' === t)
          )
            return null;
                          ...
                          if (
                            ...
                            if (this.settings.core.expand_selected_onload) {
                              var t,
                                ...
                                r = [];
                              for (
                                t = 0, i = this._data.core.selected.length;
                                i > t;
                                t++
                              )
                                r = r.concat(
                              ...
                              for (
                                t = 0,
                                  i = (r = e.vakata.array_unique(r)).length;
                                i > t;
                                t++
                              )
              ...
              function (r) {
                ...
                if ((t += s).length > 1) {
                  if (
                    (a.slice(n).each(
                      function (i, r) {
                        return 0 === e(r).text().toLowerCase().indexOf(t)
                          ? (e(r).trigger('focus'), (o = !0), !1)
                          : void 0;
                      }.bind(this),
                    ),
                    o)
                ...
                if (
                  ...
                  if (
                    (a.slice(n + 1).each(
                      function (t, i) {
                        return e(i).text().toLowerCase().charAt(0) === s
                          ? (e(i).trigger('focus'), (o = !0), !1)
                          : void 0;
                      }.bind(this),
                    ),
                    o)
        ...
        get_node: function (t, i) {
          ...
          try {
            if (this._model.data[t]) t = this._model.data[t];
              ...
              'string' == typeof t &&
              (r = e('#' + t.replace(e.jstree.idregex, '\\$&'), this.element))
                .length &&
        ...
        get_parent: function (t) {
          return (
            !(!(t = this.get_node(t)) || t.id === e.jstree.root) && t.parent
          );
        },
        ...
        load_node: function (t, i) {
          ...
          if (t.state.loaded) {
            for (t.state.loaded = !1, a = 0, n = t.parents.length; n > a; a++)
              this._model.data[t.parents[a]].children_d = e.vakata.array_filter(
            ...
            this._load_node(
              ...
              function (e) {
                ...
                var r,
                  ...
                  n = this._model.data,
                  o = !1;
                for (a = 0, r = t.children.length; r > a; a++)
                  if (n[t.children[a]] && !n[t.children[a]].state.hidden) {
                    o = !0;
                    break;
                  }
                t.state.loaded &&
                  s &&
                  s.length &&
                  (s.removeClass('jstree-closed jstree-open jstree-leaf'),
                  o
                    ? '#' !== t.id &&
                      s.addClass(
                        t.state.opened ? 'jstree-open' : 'jstree-closed',
                      )
                    : s.addClass('jstree-leaf')),
                  s.removeClass('jstree-loading').attr('aria-busy', !1),
        ...
        load_all: function (t, i) {
          ...
          var r,
            ...
            o = n[t.id].children_d;
          for (
            t.state && !t.state.loaded && a.push(t.id), r = 0, s = o.length;
            s > r;
            r++
          )
                ...
                if (n.length && n[0].id !== t && n[0].parent !== t) {
                  ...
                  for (r = 0, s = n.length; s > r; r++)
                    f[n[r].parent.toString()]
                      ? (f[n[r].parent.toString()].children.push(
                          n[r].id.toString(),
                        ),
                        p.children_d.push(n[r].id.toString()))
                      : void 0 !== o &&
                  ...
                  for (r = 0, s = p.parents.length; s > r; r++)
                    f[p.parents[r]].children_d =
                      f[p.parents[r]].children_d.concat(l);
                  a = { cnt: g, mod: f, sel: m, par: d, dpc: l, add: h };
                } else {
                  for (r = 0, s = n.length; s > r; r++)
                ...
                if (null !== this.element) {
                  ...
                  if (((this._model.data = t.mod), i)) {
                    ...
                    if (
                      ((a = this._model.data),
                      l.length !== h.length ||
                        e.vakata.array_unique(l.concat(h)).length !== l.length)
                    ) {
                ...
                null === this._wrk &&
                  ...
                  !this._data.core.working || s
                    ? ((this._data.core.working = !0),
                      ((a = new window.Worker(this._wrk)).onmessage = function (
                        e,
                      ) {
        ...
        _parse_model_from_html: function (i, r, s) {
          ...
          if (
            ...
            e.each(d, function (t, i) {
              return (
                ...
                ((h.li_attr[t] = i), void ('id' === t && (h.id = i.toString())))
              );
            }),
          ...
          (d = i.children('a').children('.jstree-themeicon')).length &&
            (h.icon = !d.hasClass('jstree-themeicon-hidden') && d.attr('rel')),
        ...
        _parse_model_from_flat_json: function (e, i, r) {
          ...
          for (
            e &&
              e.children &&
              !0 === e.children &&
              ((h.state.loaded = !1), (h.children = []), (h.children_d = [])),
              c[h.id] = h,
              s = 0,
              a = h.children.length;
            a > s;
        ...
        _parse_model_from_json: function (e, i, r) {
          ...
          if (e && e.children && e.children.length) {
            for (s = 0, a = e.children.length; a > s; s++)
              (o =
                l[(n = this._parse_model_from_json(e.children[s], d.id, r))]),
                d.children.push(n),
                o.children_d.length &&
                  (d.children_d = d.children_d.concat(o.children_d));
          ...
          return (
            e &&
              e.children &&
              !0 === e.children &&
              ((d.state.loaded = !1), (d.children = []), (d.children_d = [])),
            delete e.data,
            delete e.children,
            (d.original = e),
            (l[d.id] = d),
        ...
        _redraw: function () {
          ...
          for (i = 0, r = s.length; r > i; i++)
            (t = this.redraw_node(s[i], !0, this._model.force_full_redraw)) &&
        ...
        draw_children: function (t) {
          ...
          if (
            ...
            for (
              (a = n.createElement('UL')).setAttribute('role', 'group'),
        ...
        redraw_node: function (t, i, r, s) {
          ...
          if (
            ...
            (t = e(t)),
              r ||
                ((n = t.parent().parent()[0]) === this.element[0] && (n = null),
                (o = t.index())),
              i ||
                !a.children.length ||
            ...
            o = e.inArray(
              a.id,
              null === n ? f[e.jstree.root].children : f[a.parent].children,
            );
          }
          ...
          if (
            ...
            f[a.parent] &&
            !a.state.hidden &&
            ((l = e.inArray(a.id, f[a.parent].children)), (b = a.id), -1 !== l)
          )
            for (
          ...
          if (
            ...
            this.settings.core.force_text
              ? t.childNodes[1].appendChild(g.createTextNode(a.text))
              : (t.childNodes[1].innerHTML += a.text),
            i && a.children.length && (a.state.opened || s) && a.state.loaded)
          ) {
            for (
              (_ = g.createElement('UL')).setAttribute('role', 'group'),
          ...
          if ((c && t.appendChild(c), !r)) {
            for (
              n || (n = this.element[0]), l = 0, h = n.childNodes.length;
              h > l;
              l++
            )
              if (
                ...
                -1 !== n.childNodes[l].className.indexOf('jstree-children')
              ) {
                m = n.childNodes[l];
                break;
              }
            m ||
              ((m = g.createElement('UL')).setAttribute('role', 'group'),
        ...
        open_node: function (i, r, s) {
          ...
          if (e.vakata.is_array(i)) {
            for (a = 0, n = (i = i.slice()).length; n > a; a++)
              ...
              ? this.is_loaded(i)
                ? ((o = this.get_node(i, !0)),
                  ...
                  o.length &&
                    ...
                    i.children.length &&
                      !this._firstChild(o.children('.jstree-children')[0]) &&
                      this.draw_children(i),
                    s
                      ? (this.trigger('before_open', { node: i }),
                        o
                          .children('.jstree-children')
                          .css('display', 'none')
                          .end()
                          ...
                          .slideDown(s, function () {
                            (this.style.display = ''),
                              d.element && d.trigger('after_open', { node: i });
                          }))
                      : (this.trigger('before_open', { node: i }),
                  ...
                  (i.state.opened = !0),
                  r && r.call(this, i, !0),
                  o.length || this.trigger('before_open', { node: i }),
                  this.trigger('open_node', { node: i }),
                  (s && o.length) || this.trigger('after_open', { node: i }),
                  !0)
                : this.is_loading(i)
                ? setTimeout(
                    function () {
        ...
        close_node: function (i, r) {
          var s, a, n, o;
          if (e.vakata.is_array(i)) {
            for (s = 0, a = (i = i.slice()).length; a > s; s++)
                ...
                ? o
                    ...
                    .slideUp(r, function () {
                      (this.style.display = ''),
                        ...
                        n.element && n.trigger('after_close', { node: i });
                    })
                : ((o[0].className = o[0].className.replace(
                    'jstree-open',
                    'jstree-closed',
        ...
        toggle_node: function (t) {
          ...
          if (e.vakata.is_array(t)) {
            for (i = 0, r = (t = t.slice()).length; r > i; i++)
          ...
          if (!o.length) {
            for (s = 0, a = t.children_d.length; a > s; s++)
              this.is_closed(this._model.data[t.children_d[s]]) &&
                (this._model.data[t.children_d[s]].state.opened = !0);
        ...
        hide_node: function (t, i) {
          var r, s;
          if (e.vakata.is_array(t)) {
            for (r = 0, s = (t = t.slice()).length; s > r; r++)
        ...
        dehover_node: function (e) {
          return (
            ...
            void this.trigger('dehover_node', { node: this.get_node(e) }))
          );
        },
        select_node: function (t, i, r, s) {
          var a, n, o;
          if (e.vakata.is_array(t)) {
            for (n = 0, o = (t = t.slice()).length; o > n; n++)
        ...
        deselect_node: function (t, i, r) {
          var s, a, n;
          if (e.vakata.is_array(t)) {
            for (s = 0, a = (t = t.slice()).length; a > s; s++)
        ...
        deselect_all: function (e) {
          ...
          for (t = 0, i = this._data.core.selected.length; i > t; t++)
            this._model.data[this._data.core.selected[t]] &&
              (this._model.data[this._data.core.selected[t]].state.selected =
                !1);
          (this._data.core.selected = []),
            this.element
              .find('.jstree-clicked')
        ...
        get_top_selected: function (t) {
          ...
          for (i = 0, r = n.length; r > i; i++)
            for (s = 0, a = n[i].children_d.length; a > s; s++)
        ...
        set_state: function (i, r) {
          if (i) {
            if (
              ...
              if (i.core.open)
                return (
                  e.vakata.is_array(i.core.open) && i.core.open.length
              ...
              if (i.core.scroll)
                return (
                  i.core.scroll &&
                    ...
                    this.element.scrollLeft(i.core.scroll.left),
                  i.core.scroll &&
                    i.core.scroll.top !== t &&
                    this.element.scrollTop(i.core.scroll.top),
            ...
            return (
              !e.isEmptyObject(i) ||
              ((i = null), r && r.call(this), this.trigger('set_state'), !1)
            );
          }
          return !1;
        },
        refresh: function (t, i) {
          (this._data.core.state = !0 === i ? {} : this.get_state()),
            i &&
              ...
              (this._data.core.state = i.call(this, this._data.core.state)),
            (this._cnt = 0),
            (this._model.data = {}),
            (this._model.data[e.jstree.root] = {
              id: e.jstree.root,
        ...
        set_id: function (t, i) {
          ...
          return (
            -1 !== (r = e.inArray(t.id, this._data.core.selected)) &&
        ...
        get_json: function (t, i, r) {
          ...
          var s,
            ...
            n = {
              ...
              data:
                (!i || !i.no_data) &&
                e.extend(!0, e.vakata.is_array(t.data) ? [] : {}, t.data),
            };
          if (
            (i && i.flat ? (n.parent = t.parent) : (n.children = []),
            i && i.no_state)
          )
            delete n.state;
          else
          ...
          if (
            ...
            for (s = 0, a = t.children.length; a > s; s++)
              i && i.flat
                ...
                : n.children.push(this.get_json(t.children[s], i));
          return i && i.flat ? r : t.id === e.jstree.root ? n.children : n;
        },
        create_node: function (i, r, s, a, n) {
          if ((null === i && (i = e.jstree.root), !(i = this.get_node(i))))
            return !1;
          if (
            !(s = s === t ? 'last' : s).toString().match(/^(before|after)$/) &&
            !n &&
            !this.is_loaded(i)
          )
          ...
          switch (
            ...
            (r = 'string' == typeof r ? { text: r } : e.extend(!0, {}, r))
              .text === t && (r.text = this.get_string('New node')),
            i.id === e.jstree.root &&
              ('before' === s && (s = 'first'), 'after' === s && (s = 'last')),
            s)
          ) {
            case 'before':
          ...
          for (
            ...
            this._model.data[i.parents[c]].children_d =
              this._model.data[i.parents[c]].children_d.concat(d);
          for (r = o, o = [], c = 0, l = i.children.length; l > c; c++)
        ...
        rename_node: function (t, i) {
          ...
          return (
            ...
            this.check('rename_node', t, this.get_parent(t), i)
              ? (this.set_text(t, i),
                this.trigger('rename_node', { node: t, text: i, old: a }),
                !0)
              : (this.settings.core.error.call(
                  this,
                  this._data.core.last_error,
        ...
        delete_node: function (t) {
          ...
          for (
            -1 !== a && (s.children = e.vakata.array_remove(s.children, a)),
            ...
            this._model.data[t.parents[o]].children_d = e.vakata.array_filter(
          ...
          for (
            h &&
              ...
              this.trigger('delete_node', { node: t, parent: s.id }),
              h &&
                this.trigger('changed', {
                  action: 'delete_node',
                  node: t,
          ...
          if ('move_node' === t || 'copy_node' === t) {
            ...
            if (
              !(
                (a && a.is_multi) ||
                (i.id !== r.id &&
                  ('move_node' !== t || e.inArray(i.id, r.children) !== s) &&
        ...
        move_node: function (i, r, s, a, n, o, d) {
          ...
          if (!(i = i && i.id ? i : this.get_node(i)) || i.id === e.jstree.root)
            return !1;
          if (
            ((h = (i.parent || e.jstree.root).toString()),
            (u =
              s.toString().match(/^(before|after)$/) && r.id !== e.jstree.root
                ? this.get_node(r.parent)
                : r),
            (f =
              !(g =
                d ||
                (this._model.data[i.id] ? this : e.jstree.reference(i.id))) ||
              !g._id ||
              this._id !== g._id),
            (_ =
              g && g._id && h && g._model.data[h] && g._model.data[h].children
                ? e.inArray(i.id, g._model.data[h].children)
                : -1),
          ...
          if (i.parent === u.id) {
            ...
            for (
              ...
              for (
                p = [],
                  k = 0,
                  b = (y = g._model.data[i.parents[v]].children_d).length;
                b > k;
                k++
              )
            ...
            for (
              g._model.data[h].children = e.vakata.array_remove_item(
            ...
            for (p = [], v = 0, j = u.children.length; j > v; v++)
            ...
            for (
              ...
              (this._model.data[i.children_d[v]].parents = this._model.data[
                i.children_d[v]
              ].parents.slice(0, -1 * y)),
        ...
        copy_node: function (i, r, s, a, n, o, d) {
          ...
          if (
            !(f = v
              ? v.get_json(i, { no_id: !0, no_data: !0, no_state: !0 })
              : i)
          )
            return !1;
          if (
          ...
          for (h = [], u = 0, g = m.children.length; g > u; u++)
          ...
          return (
            ...
            this.trigger('copy_node', {
              ...
              old_parent: p,
              old_position:
                v && v._id && p && v._model.data[p] && v._model.data[p].children
        ...
        paste: function (e, t) {
          return (
            ...
            (this[s](r, e, t, !1, !1, !1, a) &&
              this.trigger('paste', { parent: e.id, node: r, mode: s }),
            (r = !1),
            (s = !1),
            void (a = !1))
          );
                ...
                (h = e('<input />', {
                  ...
                  blur: function (i) {
                    ...
                    '' === a && (a = c),
                      ...
                      (c = d
                        ? c
                        : e('<div></div>').append(e.parseHTML(c)).html()),
                      (t = this.get_node(t)),
                      this.set_text(t, c),
                      (s = !!this.rename_node(
                        t,
                        d
                          ...
                          : e('<div></div>').append(e.parseHTML(a)).html(),
                      )) || this.set_text(t, c),
                      (this._data.core.focused = u.id),
                      setTimeout(
                        function () {
      ...
      (e.jstree.plugins.changed = function (e, t) {
        ...
        (this.trigger = function (e, r) {
          ...
          if ((r || (r = {}), 'changed' === e.replace('.jstree', ''))) {
            ...
            for (s = 0, a = r.selected.length; a > s; s++)
              n[r.selected[s]]
                ? (n[r.selected[s]] = 2)
    ...
    (u.className = 'jstree-icon jstree-checkbox'),
                  ...
                  for (i = 0, r = a.length; r > i; i++)
                    (s[a[i]].state.checked =
                      ...
                      (s[a[i]].original &&
                        ...
                        s[a[i]].original.state.checked)),
                      s[a[i]].state.checked &&
                        this._data.checkbox.selected.push(a[i]);
                }.bind(this),
              ),
              ...
              this.element
                .on(
                  ...
                  function (t, i) {
                    ...
                    if (-1 !== u.indexOf('down'))
                      if (l.state[g ? 'selected' : 'checked']) {
                        ...
                        this._data[g ? 'core' : 'checkbox'].selected =
                          this._data[g ? 'core' : 'checkbox'].selected.concat(
                            h,
                          );
                      } else
                        for (s = 0, a = h.length; a > s; s++)
                    ...
                    if (-1 !== u.indexOf('up')) {
                      for (s = 0, a = l.children_d.length; a > s; s++)
                        c[l.children_d[s]].children.length ||
                          _.push(c[l.children_d[s]].parent);
                      for (
                        n = 0, o = (_ = e.vakata.array_unique(_)).length;
                        o > n;
                        n++
                      )
                        for (l = c[_[n]]; l && l.id !== e.jstree.root; ) {
                          for (r = 0, s = 0, a = l.children.length; a > s; s++)
                            r +=
                          ...
                          (l.state[g ? 'selected' : 'checked'] = !0),
                            this._data[g ? 'core' : 'checkbox'].selected.push(
                              l.id,
                            ),
                            (d = this.get_node(l, !0)) &&
                              d.length &&
                              d
                                ...
                                .children('.jstree-anchor')
                                .addClass(
                                  g ? 'jstree-clicked' : 'jstree-checked',
                                ),
                  ...
                  function (t, i) {
                    ...
                    if (-1 !== l.indexOf('up'))
                      for (; c && c.id !== e.jstree.root; ) {
                        for (a = 0, r = 0, s = c.children.length; s > r; r++)
                          a +=
                            d[c.children[r]].state[h ? 'selected' : 'checked'];
                        if (a !== s) break;
                        (c.state[h ? 'selected' : 'checked'] = !0),
                          ...
                          (n = this.get_node(c, !0)) &&
                            ...
                            n
                              ...
                              .children('.jstree-anchor')
                              .addClass(
                                h ? 'jstree-clicked' : 'jstree-checked',
                              ),
                ...
                .on(
                  ...
                  function (t, i) {
                    var r,
                      ...
                      n = i.node,
                      o =
                        (this.get_node(n, !0), this.settings.checkbox.cascade),
                    ...
                    if (-1 !== o.indexOf('up') && -1 === c.indexOf(n.id)) {
                      for (r = 0, s = n.parents.length; s > r; r++)
                        ((a = this._model.data[n.parents[r]]).state[
                          d ? 'selected' : 'checked'
                        ] = !1),
                          a &&
                            a.original &&
                          ...
                          (a = this.get_node(n.parents[r], !0)) &&
                            ...
                            a
                              ...
                              .children('.jstree-anchor')
                              .removeClass(
                                d ? 'jstree-clicked' : 'jstree-checked',
                              );
                      c = e.vakata.array_filter(c, function (e) {
                ...
                .on(
                  ...
                  function (t, i) {
                    for (
                      ...
                      for (a = 0, r = 0, s = o.children.length; s > r; r++)
                  ...
                  function (t, i) {
                    ...
                    if (!d)
                      for (
                        ...
                        for (s = 0, a = 0, n = r.children.length; n > a; a++)
                          s +=
                            h[r.children[a]].state[_ ? 'selected' : 'checked'];
                        if (!(n > 0 && s === n)) break;
            ...
            for (r = 0, s = l.length; s > r; r++)
              if (d[l[r]] && d[l[r]].parents)
                for (
                  ...
                  n > a && o[d[l[r]].parents[a]] === t;
                  a++
                )
                  d[l[r]].parents[a] !== e.jstree.root &&
                    ((o[d[l[r]].parents[a]] = !0), h.push(d[l[r]].parents[a]));
            for (
              this.element
                .find('.jstree-closed')
                  ...
                  if (c)
                    if (c.state.loaded) {
                      for (r = 0, s = c.children_d.length; s > r; r++)
                        if (
                          !(i = d[c.children_d[r]]).state.loaded &&
                          i.original &&
                          i.original.state &&
                          i.original.state.undetermined &&
                          !0 === i.original.state.undetermined
                        )
                          for (
                            o[i.id] === t &&
                              i.id !== e.jstree.root &&
                              ((o[i.id] = !0), h.push(i.id)),
                              a = 0,
                              n = i.parents.length;
                            n > a;
                            a++
                            ...
                            o[i.parents[a]] === t &&
                              i.parents[a] !== e.jstree.root &&
                              ((o[i.parents[a]] = !0), h.push(i.parents[a]));
                    } else if (
                      c.original &&
                      c.original.state &&
                      ...
                      for (
                        ...
                        o[c.parents[a]] === t &&
                          ...
                          ((o[c.parents[a]] = !0), h.push(c.parents[a]));
                }),
                r = 0,
                s = h.length;
              s > r;
            ...
            if ((e = r.redraw_node.apply(this, arguments))) {
              ...
              for (a = 0, n = e.childNodes.length; n > a; a++)
                if (
                  ...
                  -1 !== e.childNodes[a].className.indexOf('jstree-anchor')
                ) {
                  o = e.childNodes[a];
                  break;
                }
            ...
            for (i = 0, r = t.children_d.length; r > i; i++)
              if (
                ...
                (!o[t.children_d[i]].state.loaded &&
                  o[t.children_d[i]].original.state.undetermined)
              )
                return !0;
            return !1;
          }),
          ...
          (this._cascade_new_checked_state = function (e, t) {
            ...
            if (
              (!this.settings.checkbox.cascade_to_disabled &&
                n.state.disabled) ||
              (!this.settings.checkbox.cascade_to_hidden && n.state.hidden)
            )
              ...
              if (n.children)
                for (i = 0, r = n.children.length; r > i; i++) {
                  var c = n.children[i];
                ...
                h
                  ? ((n.state[a ? 'selected' : 'checked'] = !1),
                    l
                      .attr('aria-selected', !1)
                      .children('.jstree-anchor')
                      .removeClass(a ? 'jstree-clicked' : 'jstree-checked'))
                  ...
                  ? ((n.state[a ? 'selected' : 'checked'] = t),
                    ...
                    l
                      .attr('aria-selected', !0)
                      .children('.jstree-anchor')
                      .addClass(a ? 'jstree-clicked' : 'jstree-checked'))
                  : ((n.state[a ? 'selected' : 'checked'] = !1),
                    l
                      .attr('aria-selected', !1)
                      .children('.jstree-anchor')
          ...
          (this.check_node = function (t, i) {
            ...
            return (
              ...
              void (
                ...
                r &&
                  r.length &&
                  r.children('.jstree-anchor').addClass('jstree-checked'),
          ...
          (this.uncheck_node = function (t, i) {
            ...
            return (
              ...
              void (
                ...
                a.length &&
                  a.children('.jstree-anchor').removeClass('jstree-checked'),
      ...
      (e.jstree.plugins.conditionalselect = function (e, t) {
        this.activate_node = function (e, i) {
          return this.settings.conditionalselect.call(this, this.get_node(e), i)
            ? t.activate_node.call(this, e, i)
            : void 0;
        };
      }),
        ...
        (this.bind = function () {
          ...
          this.element
            ...
            .on('touchmove.vakata.jstree', function (r) {
              a &&
                ...
                r.originalEvent.changedTouches &&
                r.originalEvent.changedTouches[0] &&
                (Math.abs(t - r.originalEvent.changedTouches[0].clientX) > 10 ||
                  Math.abs(i - r.originalEvent.changedTouches[0].clientY) >
                    10) &&
          ...
          (this._show_contextmenu = function (t, i, r, s) {
            ...
            e(d).one(
              ...
              this.trigger('show_contextmenu', { node: t, x: i, y: r });
          });
      }),
      (function (e) {
        var t = !1,
              ...
              e.each(t, function (t, r) {
                return (
                  ...
                  (a +=
                    ...
                    '</a>'),
                  r.submenu &&
                    (s = e.vakata.context._parse(r.submenu, !0)) &&
                    (a += s),
                  (a += '</li>'),
                  void (
                    r.separator_after &&
          ...
          _show_submenu: function (i) {
            if ((i = e(i)).length && i.children('ul').length) {
              ...
              t
                ...
                : i[a + o > c && s > c - a ? 'addClass' : 'removeClass'](
                    'vakata-context-right',
                  ),
                n + d + 10 > l && r.css('bottom', '-1px'),
                i.hasClass('vakata-context-right')
                  ? o > s && r.css('margin-right', s - o)
                  : o > c - a && r.css('margin-left', c - a - o),
                r.show();
            }
          },
          show: function (r, s, a) {
            var n, o, c, l, h, _, u, g;
            switch (
              (i.element && i.element.length && i.element.width(''), !0)
            ) {
              case !s && !r:
                return !1;
              case !!s && !!r:
            ...
            i.bind.call(this),
              this.element.on(
                ...
                function (t) {
                  if (
                    this.settings.dnd.large_drag_target &&
                    e(t.target).closest('.jstree-node')[0] !== t.currentTarget
                  )
                    return !0;
                  if (
                    'touchstart' === t.type &&
                  ...
                  var i = this.get_node(t.target),
                    r =
                      this.is_selected(i) && this.settings.dnd.drag_selection
                        ? this.get_top_selected().length
                        : 1,
                    s =
                      r > 1
                        ? r + ' ' + this.get_string('nodes')
          ...
          .on('dnd_move.vakata.jstree', function (o, d) {
            ...
            if (
              ...
              d &&
                d.data &&
                d.data.jstree &&
                (!d.event.target.id || 'jstree-marker' !== d.event.target.id))
            ) {
              s = d.event;
              var l,
                h,
              ...
              if (T && T._data && T._data.dnd)
                if (
                  ...
                  (d.event.target !== T.element[0] &&
                    d.event.target !== T.get_container_ul()[0]) ||
                    0 !== T.get_container_ul().children().length)
                ) {
                  if (
                    ...
                    (S =
                      (d.event.pageY !== t
                        ? d.event.pageY
                        : d.event.originalEvent.pageY) - A.top),
                    (_ = O.outerHeight()),
                    (f =
                      _ / 3 > S
                        ? ['b', 'i', 'a']
                    ...
                    e.each(f, function (t, s) {
                      switch (s) {
                        case 'b':
                          ...
                          break;
                        case 'i':
                          (y = T.settings.dnd.inside_pos),
                            (x = T.get_node(O.parent())),
                            (l = A.left - 2),
                            (h = A.top + _ / 2 + 1),
                            (u = x.id),
                            (g =
                      ...
                      for (p = !0, m = 0, v = d.data.nodes.length; v > m; m++)
                        if (
                          ...
                          'move_node' === j &&
                            ...
                            d.data.origin &&
                            d.data.origin === T &&
                            u === T.get_parent(d.data.nodes[m]) &&
                            ((b = T.get_node(u)),
                            k > e.inArray(d.data.nodes[m], b.children) &&
                              (k -= 1)),
                          !(p =
                            p &&
                            ((T &&
                              T.settings &&
                              T.settings.dnd &&
                              !1 === T.settings.dnd.check_while_dragging) ||
                              T.check(
                                j,
                                d.data.origin && d.data.origin !== T
                          ...
                          T && T.last_error && (r = T.last_error());
                          break;
                        }
                      return (
                        'i' === s &&
                          O.parent().is('.jstree-closed') &&
                          T.settings.dnd.open_timeout &&
                          (!d.event || 'dragover' !== d.event.type || c) &&
                          (a && clearTimeout(a),
                          (a = setTimeout(
                            (function (e, t) {
                  ...
                  for (
                    ...
                    (p =
                      ...
                      T.check(
                        ...
                        {
                          dnd: !0,
                          ref: T.get_node(e.jstree.root),
                          pos: 'i',
                          origin: d.data.origin,
                          is_multi: d.data.origin && d.data.origin !== T,
                          is_foreign: !d.data.origin,
                        },
                      ));
                    m++
                  ...
                  if (p)
                    return (
                      (i = { ins: T, par: e.jstree.root, pos: 'last' }),
                      n.hide(),
                      d.helper
                        .find('.jstree-icon')
                        .first()
          ...
          .on('dnd_stop.vakata.jstree', function (t, o) {
            if (
              ...
              var d,
                ...
                l = [];
              if (i) {
                for (d = 0, c = o.data.nodes.length; c > d; d++)
                  l[d] = o.data.origin
        ...
        e.vakata.dnd = {
          ...
          _scroll: function (t) {
            if (!i.scroll_e || (!i.scroll_l && !i.scroll_t))
              return (
                i.scroll_i && (clearInterval(i.scroll_i), (i.scroll_i = !1)), !1
              );
            if (!i.scroll_i)
            ...
            i.scroll_e.scrollTop(
              ...
              i.scroll_e.scrollLeft(
                s + i.scroll_l * e.vakata.dnd.settings.scroll_speed,
              ),
              (r !== i.scroll_e.scrollTop() || s !== i.scroll_e.scrollLeft()) &&
            ...
            if (
              ...
              return (
                ...
                e(e(t.target).parentsUntil('body').addBack().get().reverse())
                  .filter(function () {
                    return (
                      /^auto|scroll$/.test(e(this).css('overflow')) &&
                ...
                i.scroll_e ||
                  ...
                  (h = r.scrollLeft()),
                  a > n &&
                    t.pageY - l < e.vakata.dnd.settings.scroll_proximity &&
                    (i.scroll_t = -1),
                  a > n &&
                    n - (t.pageY - l) <
                      e.vakata.dnd.settings.scroll_proximity &&
                    (i.scroll_t = 1),
                  o > c &&
                    t.pageX - h < e.vakata.dnd.settings.scroll_proximity &&
                    (i.scroll_l = -1),
                  o > c &&
                    c - (t.pageX - h) <
                      e.vakata.dnd.settings.scroll_proximity &&
                ...
                i.helper &&
                  ...
                  i.helper.css({ left: u + 'px', top: _ + 'px' })),
                e.vakata.dnd._trigger('move', t),
                !1
              );
            }
              ...
              for (n = 0, o = t.length; o > n; n++)
                (!h[t[n]] ||
                  ...
                  (d = this.get_node(t[n], !0)) &&
                    d.length &&
                    d.addClass('jstree-loading').attr('aria-busy', !0));
                  ...
                  if (this._data.search.som && i.res.length) {
                    ...
                    for (r = 0, s = i.res.length; s > r; r++)
                      if (
                        ...
                        for (
                          a = 0, n = o[i.res[r]].children_d.length;
                          n > a;
                          a++
                        )
                          o[o[i.res[r]].children_d[a]] &&
                            !o[o[i.res[r]].children_d[a]].state.hidden &&
                            d.push(o[i.res[r]].children_d[a]);
              ...
              return e.vakata.is_function(h)
                ? h.call(
                    ...
                    function (t) {
                      t && t.d && (t = t.d),
                        this._load_nodes(
                          e.vakata.is_array(t) ? e.vakata.array_unique(t) : [],
                          function () {
              ...
              e.each(_[a || e.jstree.root].children_d, function (e, t) {
                ...
                r.text &&
                  ...
                  (!l.search_leaves_only ||
                    (r.state.loaded && 0 === r.children.length)) &&
                  ((l.search_callback && l.search_callback.call(this, i, r)) ||
                    (!l.search_callback && u.search(r.text).isMatch)) &&
                  (g.push(t), (f = f.concat(r.parents)));
              }),
              g.length)
            ) {
              for (d = 0, c = (f = e.vakata.array_unique(f)).length; c > d; d++)
                f[d] !== e.jstree.root &&
                  _[f[d]] &&
                          ...
                          .map(g, function (t) {
                            return -1 !== '0123456789'.indexOf(t[0])
                              ? '\\3' +
                                  t[0] +
                                  ' ' +
                                  t.substr(1).replace(e.jstree.idregex, '\\$&')
                              : t.replace(e.jstree.idregex, '\\$&');
                          })
                          .join(', #'),
                    ),
            ...
            if (
              ...
              for (n = 0, o = t.childNodes.length; o > n; n++)
                if (
                  ...
                  -1 !== t.childNodes[n].className.indexOf('jstree-anchor')
                ) {
                  d = t.childNodes[n];
                  break;
                }
      ...
      (function (e) {
        (e.vakata.search = function (t, i, r) {
          (r = r || {}),
            !1 !== (r = e.extend({}, e.vakata.search.defaults, r)).fuzzy &&
              (r.fuzzy = !0),
        ...
        (this.bind = function () {
          ...
          (this.sort = function (e, t) {
            ...
            if (
              ...
              for (i = 0, r = e.children_d.length; r > i; i++)
        ...
        (this.init = function (i, s) {
                    ...
                    for (n in c[l].li_attr)
                      if (c[l].li_attr.hasOwnProperty(n)) {
                        ...
                        o[d[s]].li_attr[n] === t
                          ...
                          : 'class' === n &&
                            (o[d[s]].li_attr.class =
                              c[l].li_attr.class + ' ' + o[d[s]].li_attr.class);
                      }
                    ...
                    for (n in c[l].a_attr)
                      if (c[l].a_attr.hasOwnProperty(n)) {
                        ...
                        o[d[s]].a_attr[n] === t
                          ...
                          : 'class' === n &&
                            (o[d[s]].a_attr.class =
                              c[l].a_attr.class + ' ' + o[d[s]].a_attr.class);
                      }
                }
          ...
          (this.get_json = function (t, i, s) {
            ...
            if (e.vakata.is_array(c))
              ...
              (c.type =
                c.id && o[c.id] && o[c.id].type ? o[c.id].type : 'default'),
            ...
            var d,
              ...
              _ =
                s && s.id
                  ...
                  : null;
            switch (
              ((_ = _ && _._model && _._model.data ? _._model.data : null), i)
            ) {
              case 'create_node':
              case 'move_node':
              case 'copy_node':
                if ('move_node' !== i || -1 === e.inArray(s.id, a.children)) {
                  ...
                  if (
                    d.valid_children !== t &&
                    -1 !== d.valid_children &&
                    -1 === e.inArray(s.type || 'default', d.valid_children)
                  )
                    return (
                      (this._data.core.last_error = {
                        error: 'check',
                  ...
                  if (_ && s.children_d && s.parents) {
                    for (c = 0, l = 0, h = s.children_d.length; h > l; l++)
          ...
          (this.get_type = function (t, i) {
            return (
              !!(t = this.get_node(t)) &&
              (i
                ? e.extend({ type: t.type }, this.settings.types[t.type])
                : t.type)
            );
          }),
          (this.set_type = function (i, r) {
            ...
            if (
              ((s = this.settings.types), (i = this.get_node(i)), !s[r] || !i)
            )
              return !1;
            if (
              ((l = this.get_node(i, !0)) &&
              ...
              for (c in s[o].li_attr)
                if (s[o].li_attr.hasOwnProperty(c)) {
                  ...
                  'class' === c
                    ...
                    : _[i.id].li_attr[c] === s[o].li_attr[c] &&
                      ((_[i.id].li_attr[c] = null), l && l.removeAttr(c));
                }
                ...
                if (s[o].a_attr.hasOwnProperty(c)) {
                  ...
                  'class' === c
                    ...
                    : _[i.id].a_attr[c] === s[o].a_attr[c] &&
                      ('href' === c
                        ? ((_[i.id].a_attr[c] = '#'), h && h.attr('href', '#'))
                        : (delete _[i.id].a_attr[c], h && h.removeAttr(c)));
                }
            if (s[r].li_attr !== t && 'object' == typeof s[r].li_attr)
              for (c in s[r].li_attr)
                if (s[r].li_attr.hasOwnProperty(c)) {
                  if ('id' === c) continue;
                  _[i.id].li_attr[c] === t
                    ? ((_[i.id].li_attr[c] = s[r].li_attr[c]),
                      l &&
                        ('class' === c
                          ? l.addClass(s[r].li_attr[c])
                          : l.attr(c, s[r].li_attr[c])))
                    : 'class' === c &&
                      ((_[i.id].li_attr.class =
                        s[r].li_attr[c] + ' ' + _[i.id].li_attr.class),
                    ...
                    ? ((_[i.id].a_attr[c] = s[r].a_attr[c]),
                      h &&
                        ('class' === c
                          ...
                          : h.attr(c, s[r].a_attr[c])))
                    : 'href' === c && '#' === _[i.id].a_attr[c]
                    ? ((_[i.id].a_attr.href = s[r].a_attr.href),
                      h && h.attr('href', s[r].a_attr.href))
                    : 'class' === c &&
                      ((_[i.id].a_attr.class =
                        s[r].a_attr.class + ' ' + _[i.id].a_attr.class),
              ...
              .on(
                ...
                function (e, t) {
                  ...
                  for (i = 0, r = t.selected.length; r > i; i++)
                    (s = this.get_node(t.selected[i], !0)) &&
                      s.length &&
                      s

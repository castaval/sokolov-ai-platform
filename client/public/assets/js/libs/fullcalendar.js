var FullCalendar = (function (e) {
  ...
  var Mn = {
    ...
    In = { start: yn, end: yn, date: yn, allDay: Boolean },
    Pn = r(r(r({}, Mn), In), { extendedProps: yn });
  ...
  var cr = { start: yn, end: yn, allDay: Boolean };
  function dr(e, t, n) {
    var o = (function (e, t) {
        var n = mn(e, cr),
          o = n.refined,
  ...
  function br(e, t, n, o, i) {
    ...
    return (
      ...
      u.range.end < u.range.start &&
        (u.range.end = yr(t.allDay, u.range.start, i)),
      u
    );
  }
  var Dr = (function () {
      ...
      return (
        ...
        (e.prototype.triggerEventAdd = function (e) {
          ...
          this.getCurrentData().emitter.trigger('eventAdd', {
            ...
            relatedEvents: [],
            revert: function () {
              t.dispatch({ type: 'REMOVE_EVENTS', eventStore: xr(e) });
            },
          });
        }),
      ...
      return (
        (e.prototype.setProp = function (e, t) {
          ...
          if (e in In)
            ...
            (t = Mn[e](t)), this.mutate({ standardProps: { publicId: t } });
          else if (e in Mn)
            (t = Mn[e](t)),
  ...
  var ro = ln({ year: 'numeric', month: 'long', day: 'numeric' }),
    oo = ln({ week: 'long' });
  function io(e, t, n, o) {
  ...
  var Yo = (function (e) {
      ...
      return (
        ...
        (t.prototype.getInnerContent = function () {
          ...
          return (
            void 0 === t && (t = $o(e.defaultContent, e.hookProps)),
            null == t ? null : t
          );
        }),
  ...
  function Xo() {
    ...
    return function (r, o) {
      return (
        (t && wt(t, o) && r === e) || ((e = r), (t = o), (n = Ko(r, o))), n
      );
    };
  }
  function Ko(e, t) {
      ...
      n.content &&
        ...
        (o = function (e) {
          return wo(No.Consumer, null, function (n) {
            return wo(Jo, { viewSpec: n.viewSpec }, function (o, i) {
              var a = r(r({}, e), {
        ...
        recurringTypes: [
          {
            ...
            expand: function (e, t, n) {
              var r = zn(t, { start: e.startRecur, end: e.endRecur });
              return r
                ? (function (e, t, n, r) {
                    for (
                      var o = e ? Dt(e) : null,
      ...
      Fo({
        ...
        propSetHandlers: {
          dateProfile: function (e, t) {
            t.emitter.trigger(
              'datesSet',
              r(r({}, fr(e.activeRange, t.dateEnv)), { view: t.viewApi }),
            );
          },
    ...
    function e(e) {
      ...
      var s,
        ...
        c =
          ((s = o.calendarOptions),
          (l = o.dateEnv),
          null != (u = s.initialDate) ? l.createMarker(u) : _r(s.now, l)),
    ...
    return (
      ...
      (e.prototype._handleAction = function (e) {
        ...
        this.data &&
          ...
          ('PREV' !== e.type && 'NEXT' !== e.type && Yn(p.currentRange, d)) ||
          ...
          var f = (function (e, t, n, o) {
              ...
              switch (t.type) {
                ...
                case 'FETCH_EVENT_SOURCES':
                  return si(
                    e,
                    t.sourceIds ? Dt(t.sourceIds) : ui(e, o),
                    s,
                    t.isRefetch || !1,
                    o,
                  );
    ...
    Wi = (function () {
      ...
      return (
        ...
        (e.prototype.findInsertion = function (e) {
          ...
          var S = -1;
          return (
            E < a && n[E] === s && (S = qi(r[E], e.span.end, Vi)[0]),
            {
              touchingLevel: l,
              touchingLateral: u,
              touchingEntry: c,
  ...
  var Ki = {},
    ...
    Ji = {},
    Qi = { startTime: Nt, duration: Nt, create: Boolean, sourceId: String };
  function ea(e) {
    var t = mn(e, Qi),
      n = t.refined,
      r = t.extra;
      ...
      return (
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          ...
          if (r.length > 1) {
            ...
            return wo.apply(void 0, o(['div', { className: m }], r));
          }
          return r[0];
        }),
        t
  ...
  var fa = (function (e) {
    ...
    ga = (function (e) {
      function t(t, n) {
        ...
        return (
          (r.initialNowDate = _r(n.options.now, n.dateEnv)),
      ...
      return (
        ...
        (t.prototype.computeTiming = function () {
          ...
          return (
            (i = Math.min(864e5, i)),
            {
              currentState: { nowDate: r, todayRange: ma(r) },
              nextState: { nowDate: o, todayRange: ma(o) },
              waitMs: i,
            }
          );
        }),
  ...
  var ya = (function (e) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return wo(ga, { unit: 'day' }, function (e, t) {
          return wo(
            'tr',
            { role: 'row' },
            i && i('day'),
  ...
  function wa(e, t, n) {
    ...
    for (var o in r) if (!qn(t.validRange, r[o].range)) return !1;
    return _a({ eventDrag: e }, n);
  }
  function Ra(e, t, n) {
    return !!qn(t.validRange, e.range) && _a({ dateSelection: e }, n);
  }
  function _a(e, t) {
      ...
      !(
        (e.eventDrag &&
          !(function (e, t, n, o) {
            var i = t.getCurrentData(),
              ...
              l = s.defs,
              u = s.instances,
              c = Jn(l, a.isEvent ? e.eventUiBases : { '': i.selectionConfig });
            o && (c = bt(c, o));
            var d,
              p,
              f =
            ...
            for (var m in u) {
              ...
              for (
                ...
                var x,
                  ...
                  P = _.defs[b.defId],
                  N = _.instances[m];
                if (((x = P ? new kr(t, P, N) : new kr(t, b)), !M(mr(I, t), x)))
                  return !1;
              }
            }
            return !0;
        ...
        (e.dateSelection &&
          !(function (e, t, n, o) {
            ...
            if ((o && (c = o(c)), !ka(c.constraints, u, i, e.businessHours, t)))
              return !1;
  ...
  function Ia(e, t) {
    for (var n = 0, r = e; n < r.length; n++) if (qn(r[n], t)) return !0;
    return !1;
  }
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return wo(
          ...
          Boolean(!v && p.length) && wo.apply(void 0, o(['thead', g], p)),
          Boolean(!v && f.length) && wo.apply(void 0, o(['tbody', g], f)),
          Boolean(!v && h.length) && wo.apply(void 0, o(['tfoot', g], h)),
          v && wo.apply(void 0, o(o(o(['tbody', g], p), f), h)),
        );
      }),
      (t.prototype.renderSection = function (e, t, n) {
        return 'outerContent' in e
          ? wo(To, { key: e.key }, e.outerContent)
          : wo(
              'tr',
              {
                key: e.key,
  ...
  Za.addStateEquality({ scrollerClientWidths: wt, scrollerClientHeights: wt });
  var Xa = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.elRef = _o()), t;
  ...
  function $a(e) {
    return wo(
      ...
      e.timeText && wo('div', { className: 'fc-event-time' }, e.timeText),
      wo(
        'div',
  ...
  function is(e) {
    return (
      e.event.title && wo('div', { className: 'fc-event-title' }, e.event.title)
    );
  }
  var as = function (e) {
    return wo(No.Consumer, null, function (t) {
      ...
      return (
        ...
        (t.prototype.updateSize = function () {
          var e = this.context.isRtl,
            ...
            i = (function (e) {
              for (
                var t = vo(e), n = e.getBoundingClientRect(), r = 0, o = t;
                r < o.length;
                r++
              ) {
  ...
  function ps(e) {
    ...
    var t,
      n = e.hiddenSegs;
    return { start: fs(n), end: ((t = n), t.reduce(vs).eventRange.range.end) };
  }
  function fs(e) {
                  ...
                  function (t, n, i, a) {
                    return (
                      ...
                      wo(
                        ...
                        wo(aa, r({ isHeightAuto: i, forPrint: a }, e)),
                      )
                    );
                  },
                ),
    ...
    Ss = (function () {
      function e(e) {
        ...
        (this.subjectEl = null),
          ...
          1 === (ys += 1) &&
            window.addEventListener('touchmove', bs, { passive: !1 });
      }
      return (
        (e.prototype.destroy = function () {
          this.containerEl.removeEventListener(
            ...
            (ys -= 1) ||
              window.removeEventListener('touchmove', bs, { passive: !1 });
        }),
        ...
        (e.prototype.handleMove = function (e, t) {
          if (this.isEnabled) {
            ...
            o < 0
              ...
              this.isAnimating ||
                ((this.isAnimating = !0), this.requestAnimation(_s()));
          }
        }),
          ...
          for (var i in n) {
            ...
            if (s && s.isWithinClipping(e, t)) {
              ...
              if (c >= 0 && c < f && d >= 0 && d < h) {
                ...
                v &&
                  qn(v.dateProfile.activeRange, v.dateSpan.range) &&
                  (!o || v.layer > o.layer) &&
                  ((v.componentId = i),
                  (v.context = a.context),
                  (v.rect.left += l),
  ...
  function Is(e, t) {
    return (
      (!e && !t) || (Boolean(e) === Boolean(t) && pr(e.dateSpan, t.dateSpan))
    );
  }
  function Ps(e, t) {
    for (
          ...
          (n.handleHitUpdate = function (e, t) {
            ...
            if (e) {
              ...
              (e.componentId === s.componentId &&
                ...
                (i && Ra(i, e.dateProfile, o)) || ((a = !0), (i = null));
            }
            i
              ...
              if (e) {
                ...
                i === a || (d.editable && d.droppable)
                  ? (s = (function (e, t, n) {
                    ...
                    ((l = Er(n, a.getCurrentData().eventUiBases, s, a)),
                    (c.mutatedEvents = l),
                    wa(c, e.dateProfile, a) ||
                      ((u = !0),
                      (s = null),
                      (l = null),
        ...
        (n.draggingSegEl = null),
          ...
          (n.handleHitUpdate = function (e, t, r) {
            ...
            e &&
              ...
              l &&
                ((u = Er(i, o.getCurrentData().eventUiBases, l, o)),
                (d.mutatedEvents = u),
                wa(d, e.dateProfile, o) ||
            ...
            e &&
              ...
              n.canDropElOnCalendar(o.subjectEl, a) &&
                ((s = (function (e, t, n) {
                  ...
                  return {
                    def: u,
                    instance: mt(u.defId, { start: c, end: d }),
                  };
                })(e.dateSpan, n.dragMeta, a)),
                (u.mutatedEvents = Sn(s)),
                (l = !wa(u, e.dateProfile, a)) &&
      ...
      return (
        ...
        (t.prototype.renderSimpleLayout = function (e, t) {
          ...
          return (
            ...
            wo(Jo, { viewSpec: r.viewSpec }, function (e, t) {
              return wo(
                'div',
          ...
          return (
            ...
            l &&
              u.push({
                ...
                key: 'footer',
                isSticky: !0,
                chunks: [{ key: 'main', content: Ga }],
              }),
            wo(Jo, { viewSpec: a.viewSpec }, function (e, t) {
              return wo(
                'div',
                { ref: e, className: ['fc-daygrid'].concat(t).join(' ') },
                wo(o, {
            ...
            function (e, t, u, c) {
              return wo(
                ...
                wo(
                  ...
                  wo('div', { className: 'fc-daygrid-day-bg' }, n.bgContent),
                ),
              );
            },
          );
  ...
  function al(e, t, n, o) {
    ...
    var i = e.eventRange,
      a = i.range,
      s = zn(a, { start: o[t].date, end: tt(o[n - 1].date, 1) });
    return r(r({}, e), {
      firstCol: t,
      lastCol: n - 1,
      eventRange: {
            ...
            for (var l = 0, u = e; l < u.length; l++) {
              ...
              s.push(
                wo(
                  ...
                  'bg-event' === t ? wo(os, r({ seg: c }, ar(c, i))) : rs(t),
                ),
              );
            }
          ...
          if (!t.forPrint && null !== t.clientWidth) {
            if (e) {
              ...
              if (o.length) {
                ...
                this.setState({ framePositions: new yo(i, o, !0, !1) });
              }
            }
  ...
  ll.addStateEquality({ eventInstanceHeights: wt });
  var ul = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
  ...
  function yl(e) {
    ...
    return wo(No.Consumer, null, function (n) {
      if (!e.isLabeled)
        return wo('td', { className: t.join(' '), 'data-time': e.isoTimeStr });
      var r = n.dateEnv,
        o = n.options,
        i = n.viewApi,
        a =
      ...
      return (
        ...
        (t.prototype.render = function () {
          return this.props.slatMetas.map(function (e) {
            return wo('tr', { key: e.key }, wo(yl, r({}, e)));
          });
        }),
        t
      );
        ...
        return (
          ...
          (t.renderHeadAxis = function (e, n) {
            ...
            var o = t.context.options,
              ...
              a =
                1 === ot(i.start, i.end) ? io(t.context, i.start, 'week') : {};
            return o.weekNumbers && 'day' === e
              ? wo(
                  as,
                  { date: i.start, defaultFormat: bl },
                  function (e, t, o, i) {
                    return wo(
                      'th',
                      {
                  ...
                  content: function (e) {
                    return wo(
                      ...
                      wo(
                        ...
                        e.tableColGroupNode,
                        wo('tbody', null, wo(Sl, { slatMetas: i })),
                      ),
                      wo(
                        'div',
                        { className: 'fc-timegrid-now-indicator-container' },
                        wo(ga, { unit: h ? 'minute' : 'day' }, function (e) {
  ...
  var Ll = ln({ hour: 'numeric', minute: '2-digit', meridiem: !1 }),
    Ul = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            wo(
              Ka,
              r({}, this.props, { defaultTimeFormat: Ll, extraClassNames: e }),
            )
          );
        }),
        t
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return wo(
            ...
            function (e, t) {
              return (
                t && wo('div', { className: 'fc-timegrid-col-misc', ref: e }, t)
              );
            },
          );
        }),
    ...
    Vl = (function (e) {
      ...
      return (
        ...
        (t.prototype.renderFillSegs = function (e, t) {
          var n = this.props,
            o = this.context,
            i = Al(e, n.date, n.slatCoords, o.options.eventMinHeight).map(
              function (o, i) {
                var a = e[i];
                return wo(
                  'div',
                  ...
                  'bg-event' === t
                    ? wo(os, r({ seg: a }, ar(a, n.todayRange, n.nowDate)))
                    : rs(t),
                );
              },
            );
    ...
    Yl = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return wo(ga, { unit: a ? 'minute' : 'day' }, function (l, u) {
            return wo(
              jl,
  ...
  var nu = ln({ hour: 'numeric', minute: '2-digit', meridiem: 'short' }),
    ru = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
                ...
                (function (e, t, n, r, o) {
                  ...
                  if (!1 !== i.displayEventTime) {
                    ...
                    if (
                      (a.allDay
                        ? (l = !0)
                        : Wn(e.eventRange.range)
                        ? e.isStart
                          ? (u = ir(e, t, n, null, null, s.range.start, e.end))
                          : e.isEnd
                          ? (u = ir(e, t, n, null, null, e.start, s.range.end))
                          : (l = !0)
                        : (u = ir(e, t, n)),
                      l)
                    ) {
                    ...
                    return wo('td', { className: 'fc-list-event-time' }, u);
                  }
                  return null;
                })(n, s, t, o, a),
                wo(
  ...
  var iu = (function (e) {
    ...
    return (
        ...
        return wo(
          ...
          function (e, t, n, r) {
            return wo(
              ...
              wo('div', { className: 'fc-list-empty-cushion', ref: n }, r),
            );
          },
        );
      }),
      (t.prototype.renderSegList = function (e, t) {
        ...
        return wo(ga, { unit: 'day' }, function (e, n) {
          for (var a = [], d = 0; d < c.length; d += 1) {
            ...
            if (p) {
              var f = Bt(t[d]),
                h = u + '-' + f;
              a.push(
                wo(eu, { key: f, cellId: h, dayDate: t[d], todayRange: n }),
              );
              for (
          ...
          return wo(
            ...
            wo(
              ...
              wo(
                'tr',
                null,
                wo('th', { scope: 'col', id: s }, i.timeHint),
                wo('th', { scope: 'col', 'aria-hidden': !0 }),
                wo('th', { scope: 'col', id: l }, i.eventHint),
              ),
            ),
            wo('tbody', null, a),
          );
  ...
  var du = Fo({ themeClasses: { bootstrap: cu } }),
    pu = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
  ...
  var fu = Fo({ themeClasses: { bootstrap5: pu } }),
    hu = Fo({
      eventSourceDefs: [
        {
          parseMeta: function (e) {

        ...
        function (e, t, n) {
          (function (n) {
            ...
            function f(e) {
              ...
              return {
                left: t.left + s('scrollLeft', 'pageXOffset'),
                top: t.top + s('scrollTop', 'pageYOffset'),
              };
            }
            function s(e, t) {
              return void 0 !== n[t] ? n[t] : c.clientHeight ? c[e] : u.body[e];
            }
            function d(e, t, n) {
              var r,
                o = (e = e || {}).className || '';
            ...
            t.exports = function (e, t) {
              var n,
                ...
                _,
                X = arguments.length;
              1 === X && !1 === Array.isArray(e) && ((t = e), (e = []));
              var L,
                Y = null,
                A = t || {};
              void 0 === A.moves && (A.moves = m),
                void 0 === A.accepts && (A.accepts = m),
                void 0 === A.invalid && (A.invalid = V),
                void 0 === A.containers && (A.containers = e || []),
                void 0 === A.isContainer && (A.isContainer = v),
                ...
                void 0 === A.mirrorContainer && (A.mirrorContainer = u.body);
              var B = r({
              ...
              return (
                !0 === A.removeOnSpill && B.on('over', oe).on('out', ie), D(), B
              );
              function P(e) {
                return -1 !== B.containers.indexOf(e) || A.isContainer(e);
              }
              function D(e) {
                var t = e ? 'remove' : 'add';
                a(c, t, 'mousedown', R), a(c, t, 'mouseup', J);
              }
              function F(e) {
                a(c, e ? 'remove' : 'add', 'mousemove', q);
              }
              function M(e) {
                var t = e ? 'remove' : 'add';
                o[t](c, 'selectstart', j), o[t](c, 'click', j);
              }
              function k() {
                D(!0), J({});
              }
                ...
                if (L)
                  if (0 !== l(e)) {
                    if (
                      !(
                        void 0 !== e.clientX &&
                        Math.abs(e.clientX - S) <= (A.slideFactorX || 0) &&
                        void 0 !== e.clientY &&
                        Math.abs(e.clientY - C) <= (A.slideFactorY || 0)
                      )
                    ) {
                      if (A.ignoreInputTextSelection) {
                        var t = b('clientX', e) || 0,
                          n = b('clientY', e) || 0;
                        if (y(u.elementFromPoint(t, n))) return;
                      }
                      var r = L;
                      F(!0), M(), $(), H(r);
                      var o = f(T);
              ...
              function U(e) {
                if (!((B.dragging && n) || P(e))) {
                  ...
                  if (r)
                    if (!A.invalid(e, t))
                      if (A.moves(e, r, t, w(e))) return { item: e, source: r };
                }
              }
              function K(e) {
                return !!U(e);
              ...
              function H(e) {
                fe(e.item, e.source) &&
                  ((N = e.item.cloneNode(!0)),
                  B.emit('cloned', N, e.item, 'copy')),
                  (s = e.source),
                  (T = e.item),
                  (O = I = w(e.item)),
                  (B.dragging = !0),
              ...
              function Q(e, t) {
                var n = g(e);
                N && A.copySortSource && t === s && n.removeChild(T),
                  te(t)
                    ? B.emit('cancel', e, s, s)
                    : B.emit('drop', e, t, s, I),
                  ee();
              ...
              function Z(e) {
                if (B.dragging) {
                  ...
                  !1 === o &&
                    t &&
                    (N ? r && r.removeChild(N) : s.insertBefore(n, O)),
                    o || t
                      ? B.emit('cancel', n, s, s)
                      : B.emit('drop', n, r, s, I),
                    ee();
              ...
              function te(e, t) {
                var r;
                return (
                  (r = void 0 !== t ? t : n ? I : w(N || T)), e === s && r === O
                );
              }
              function ne(e, t, n) {
                for (var r = e; r && !o(); ) r = g(r);
                return r;
                function o() {
                  if (!1 === P(r)) return !1;
                  var o = ae(r, e),
                    i = le(r, o, t, n);
                  return !!te(r, i) || A.accepts(T, r, s, i);
                }
              }
              function re(e) {
                if (n) {
                  ...
                  var u = N || T,
                    ...
                    a = ne(c, t, r),
                    l = null !== a && a !== Y;
                  (l || null === a) && (Y && p('out'), (Y = a), l && p('over'));
                  var f = g(u);
                  if (a !== s || !N || A.copySortSource) {
                    var v,
                      m = ae(a, c);
                    if (null !== m) v = le(a, m, t, r);
                    else {
                      if (!0 !== A.revertOnSpill || N)
                        return void (N && f && f.removeChild(u));
                      (v = O), (a = s);
                    }
                    ((null === v && l) || (v !== u && v !== w(u))) &&
                      ((I = v),
              ...
              function ue() {
                if (!n) {
                  ...
                  ((n = T.cloneNode(!0)).style.width = p(e) + 'px'),
                    (n.style.height = h(e) + 'px'),
                    i.rm(n, 'gu-transit'),
                    i.add(n, 'gu-mirror'),
                    A.mirrorContainer.appendChild(n),
                    a(c, 'add', 'mousemove', re),
                    i.add(A.mirrorContainer, 'gu-unselectable'),
                    B.emit('cloned', n, T, 'mirror');
                }
              }
              function ce() {
                n &&
                  (i.rm(A.mirrorContainer, 'gu-unselectable'),
                  a(c, 'remove', 'mousemove', re),
                  g(n).removeChild(n),
                  (n = null));
              }
              function ae(e, t) {
              ...
              function le(e, t, n, r) {
                var o = 'horizontal' === A.direction;
                return t !== e
                  ? (function () {
                      var e = t.getBoundingClientRect();
                      if (o) return i(n > e.left + p(e) / 2);
                      return i(r > e.top + h(e) / 2);
                    })()
                  : (function () {
                      var t,
                        i,
                      ...
                      for (t = 0; t < c; t++) {
                        if (
                          ...
                          o && u.left + u.width / 2 > n)
                        )
                          return i;
                        if (!o && u.top + u.height / 2 > r) return i;
                      }
                      return null;
                    })();
                function i(e) {
              ...
              function fe(e, t) {
                return 'boolean' == typeof A.copy ? A.copy : A.copy(e, t);
              }
            };
          }.call(
            this,
            ...
            return (
              ...
              (e.emitterSnapshot = function (t) {
                ...
                return function () {
                  var i = r(arguments),
                    c = this || e;
                  if ('error' === t && !1 !== n.throws && !u.length)
                    throw 1 === i.length ? i[0] : i;
                  return (
                    u.forEach(function (r) {
                      n.async ? o(r, i, c) : r.apply(c, i),
                        r._once && e.off(t, r);
                    }),
                    e
                  );
            ...
            function l(e, t, n) {
              var r = (function (e, t, n) {
                ...
                for (r = 0; r < a.length; r++)
                  if ((o = a[r]).element === e && o.type === t && o.fn === n)
                    return r;
              })(e, t, n);
              if (r) {
                var o = a[r].wrapper;
              ...
              ((u = function (e, t, r) {
                return e.attachEvent(
                  ...
                  (function (e, t, r) {
                    ...
                    return (
                      a.push({ wrapper: o, element: e, type: t, fn: r }), o
                    );
                  })(e, t, r),
                );
              }),
                  ...
                  var u =
                    -1 === o.indexOf(t)
                      ...
                      : (function () {
                          var e;
                          i.createEvent
                            ? (e = i.createEvent('Event')).initEvent(t, !0, !0)
                            : i.createEventObject &&
          ...
          (i.nextTick = function (e) {
            ...
            if (arguments.length > 1)
              for (var n = 1; n < arguments.length; n++)
                t[n - 1] = arguments[n];
            f.push(new p(e, t)), 1 !== f.length || s || a(m);
          }),
